M:input_manager
F:G$engine_input_manager_init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_input_manager_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_input_manager_hold$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Linput_manager.engine_input_manager_hold$data$1_0$92({1}SC:U),B,1,4
F:G$engine_input_manager_move$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Linput_manager.engine_input_manager_move$data$1_0$94({1}SC:U),B,1,4
F:Finput_manager$my_hold_method$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Linput_manager.my_hold_method$data$1_0$96({1}SC:U),B,1,4
F:Finput_manager$my_move_method$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Linput_manager.my_move_method$data$1_0$98({1}SC:U),B,1,4
S:Finput_manager$curr_joypad1$0_0$0({2}SI:U),E,0,0
S:Finput_manager$prev_joypad1$0_0$0({2}SI:U),E,0,0
S:Finput_manager$hold_method$0_0$0({2}DC,DF,SC:U),E,0,0
S:Finput_manager$move_method$0_0$0({2}DC,DF,SC:U),E,0,0
