...
S:Loption_screen.screen_option_screen_load$idx$1_0$118({1}SC:U),R,0,0,[b]
F:G$screen_option_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Loption_screen.screen_option_screen_update$screen_type$1_0$121({2}DG,SC:U),B,1,4
S:Loption_screen.screen_option_screen_update$input1$1_0$122({1}SC:U),R,0,0,[c]
S:Loption_screen.screen_option_screen_update$input2$1_0$122({1}SC:U),R,0,0,[l]
S:Loption_screen.screen_option_screen_update$input3$1_0$122({1}SC:U),R,0,0,[l]
...
T:Foption_screen$tag_struct_command_object[({0}S:S$frame_index$0_0$0({2}SI:U),Z,0,0)({2}S:S$prev_command$0_0$0({1}SC:U),Z,0,0)]
